...
class JdbcVideoService implements VideoService {
    ...
    private final Function<Map<String, Object>, Video> videoMapper = row -> new Video(
            (String) row.get("video_id"), (String) row.get("title"),
            url((String) row.get("standard_thumbnail")), (String) row.get("description"),
    ...
    public Channel channelById(String id) {
        ...
        var res =  this.jdbcTemplate.query(sql, (rs, rowNum) ->
                new Channel(rs.getString("channel_id")), id);
    ...
    public List<Channel> channels() {
        ...
        return this.jdbcTemplate.query(sql, (rs, rowNum) ->
                new Channel(rs.getString("channel_id")));
    }
        ...
        public Video mapRow(ResultSet rs, int rowNum) {
            try {
                return new Video(
                        ...
                        rs.getString("title"),
                        URI.create(rs.getString("standard_thumbnail")).toURL(),
